         ...
         <div
          ...
          <div className="mt-8 text-center">
            ...
            <p className="max-w-2xl mx-auto text-sm mt-2 text-gray-700 dark:text-gray-300">
              Egy eszköz vételára 16 000 Ft + ÁFA, több termék vásárlása esetén további kedvezmények érhetőek el. Teszteld a rendszert 3 hónapig ingyenesen. Amennyiben nem találsz megfelelőt, az eszközre pénzvisszafizetési garanciát biztosítunk.
            </p>
          </div>
